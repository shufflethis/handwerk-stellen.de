  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von handwerk-stellen.de. Mit jahrelanger Erfahrung im
      ...
      <div className="autorenbox-links">
        <a href="https://handwerk-stellen.de/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
